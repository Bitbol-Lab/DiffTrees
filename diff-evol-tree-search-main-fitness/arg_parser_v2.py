...
def parse_args_v2():
    ...
    parser.add_argument('-field', '--fitness_field', action='store_true', help='Use Field component of Fitness?')
    parser.set_defaults(initialize_seq=False)  
    parser.add_argument('-coupling', '--fitness_coupling', action='store_true', help='Use Coupling component of Fitness?')
    parser.set_defaults(initialize_seq=False)
